...
public class KeyProperties {
    ...
    public static final String PATH = "/source_articles";
    public static final String PATH_NOTIFICATION = "/source_notification";
    public static final String GET_DATA_MESSAGE = "get_data_for_wearable";
    public static final String MARK_READ_MESSAGE = "mark_article_read";
