...
import com.klinker.android.twitter_l.ui.tweet_viewer.fragments.ConversationFragment;
import com.klinker.android.twitter_l.ui.tweet_viewer.fragments.TweetFragment;
import com.klinker.android.twitter_l.ui.tweet_viewer.fragments.TweetYouTubeFragment;
import com.klinker.android.twitter_l.ui.tweet_viewer.fragments.MobilizedFragment;
import com.klinker.android.twitter_l.ui.tweet_viewer.fragments.WebFragment;
...
public class TweetPagerAdapter extends FragmentPagerAdapter {
    ...
    public TweetPagerAdapter(FragmentManager fm, Context context,
        ...
        pageCount = 1; // tweet, conversations, and Discussion will always be there
    ...
    public Fragment getItem(int i) {
        ...
        } else if (pageCount == 2) { // no youtube, just a webpage
            switch (i) {
                case 0:
    ...
    public CharSequence getPageTitle(int i) {
        ...
        } else if (pageCount == 2) { // no youtube, just a hasWebpage
            switch (i) {
                case 0:
