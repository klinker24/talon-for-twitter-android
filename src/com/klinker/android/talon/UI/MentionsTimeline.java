...
public class MentionsTimeline extends Activity implements PullToRefreshAttacher.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dataSource = new MentionsDataSource(this);
        dataSource.open();
    ...
    public void setUpDrawer() {
        ...
        drawerList.setOnItemClickListener(new MainDrawerClickListener(context, mDrawerLayout));
