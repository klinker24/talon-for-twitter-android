...
public class LinksFragment extends Fragment implements OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.v("setting_fragments", "links fragment");
        ...
        //new GetCursorAdapter(true).execute(); // display spinner
    ...
    public void getCursorAdapter(final boolean bSpinner) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final Cursor cursor = HomeDataSource.getInstance(context).getLinksCursor(sharedPrefs.getInt("current_account", 1));
